...
'<td><select name="image" id="image">  <option value="ok">bien</option>  <option value="false">mal</option> </select> </td> <td>En edición</td>';
...
'<input class="btn  btn-outline-primary" type = "submit" value="Aceptar"> <input class="btn   btn-outline-secondary" type="reset" value="Cancelar">';
editando = "true";}
...
'<input class="btn  btn-outline-secondary" type = "submit" value="Aceptar"> <input class="btn   btn-outline-secondary" type="reset" value="Cancelar">';
